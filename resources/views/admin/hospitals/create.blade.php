...
@section('title', 'Ajouter un centre de santé')
...
@section('content')
    <div class="mx-auto space-y-6" style="width:70%">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Ajouter un centre de santé</h1>
                <p class="text-slate-500 text-sm mt-1">Créez un accès pour un nouvel hôpital, clinique ou SAMU.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
            <form action="{{ route('admin.hospitals.store') }}" method="POST" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {{-- Type de service (Centre de santé figé) --}}
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Type d'entité <span class="text-red-500">*</span></label>
                            <input type="text" value="Centre de santé" class="w-full px-4 py-3 bg-slate-100 border border-slate-200 rounded-xl font-semibold text-slate-700 outline-none cursor-not-allowed" readonly>
                        </div>
                    </div>

                    {{-- Nom du centre --}}
                    <div>
                        <label for="name" class="block text-sm font-semibold text-slate-700 mb-2">Nom de l'établissement <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="name" id="name" value="{{ old('name') }}"
                            placeholder="Ex: CHU d'Angré, Clinique Farah"
                ...
                <div class="grid grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3 p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                                ...
                                <label for="has_ambulance" class="text-sm text-slate-700 cursor-pointer flex items-center gap-1.5 select-none font-medium">
                    ...
                    <div>
                        ...
                        <input type="text" name="adresse" id="adresse" value="{{ old('adresse') }}"
                            placeholder="Rechercher uniquement les centres de santé (hôpitaux, cliniques...)"
                ...
                <div class="flex items-center justify-end gap-3 pt-6 border-t border-slate-100">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-check mr-2"></i> Créer le centre
                    </button>
                </div>
            </form>
        </div>
...
@push('scripts')
    ...
    <script>
        function initMap() {
            ...
            // Restreindre la recherche uniquement aux hôpitaux/centres de santé
