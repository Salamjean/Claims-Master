...
@section('content')
    <div class="mx-auto px-4 py-8" style="width: 100%;">
        ...
        <div class="flex items-center justify-between mb-6 flex-wrap gap-4">
            <div>
                <div
                    class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-700 text-xs font-black uppercase tracking-widest border border-blue-100 mb-3">
                    <span class="w-2 h-2 rounded-full bg-blue-600 animate-pulse"></span>
                    Suivi GPS en direct
                </div>
                <h1 class="text-2xl font-black text-slate-800">Votre agent est en route</h1>
                <p class="text-sm text-slate-500 mt-1">Dossier <span
                        class="text-blue-600 font-bold">#{{ $sinistre->numero_sinistre }}</span></p>
            </div>
                    ...
                    <div class="p-5 border-t border-slate-100">
                        <div class="flex items-center justify-between flex-wrap gap-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-12 h-12 rounded-2xl bg-blue-600 flex items-center justify-center text-white text-xl shadow">
                                    <i class="fa-solid fa-route"></i>
                                </div>
                                <div>
                                    <p class="text-xs text-slate-400 font-black uppercase tracking-widest">Temps d'arrivée
                                        estimé</p>
                                    <p class="text-2xl font-black text-slate-800 eta-pulse" id="eta-text">Calcul en cours...
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-xs text-slate-400 font-bold mt-1 text-right"><span id="progress-pct">0</span>%
                                parcouru</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-5">
                <div class="tracking-card p-6">
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div
                            class="w-20 h-20 rounded-2xl bg-blue-50 border-4 border-blue-100 flex items-center justify-center mb-4 overflow-hidden shadow">
                            @if($sinistre->assignedAgent->profile_picture ?? false)
                                <img src="{{ asset('storage/' . $sinistre->assignedAgent->profile_picture) }}"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-mono font-bold text-slate-700">
                                    {{ number_format($sinistre->latitude, 4) }}, {{ number_format($sinistre->longitude, 4) }}
                                </p>
                            </div>
                        </div>
                    </div>
