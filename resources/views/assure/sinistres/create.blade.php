        ...
        <form action="{{ route('assure.sinistres.store') }}" method="POST" enctype="multipart/form-data" id="sinistre-form"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 overflow-hidden relative animate-in flex flex-col"
                    ...
                    <div class="p-6 md:p-8 flex-1 flex flex-col">
                        ...
                        <div class="flex flex-col gap-5 flex-1">
                            <div>
                                <label class="block text-sm font-bold text-slate-700 mb-3">Types d'incidents <span class="text-red-500">*</span></label>
                                <div class="grid grid-cols-1 gap-2">
                                    ...
                                    @foreach($incidents as $value => $data)
                                        <label class="relative flex items-center p-3 rounded-xl border border-slate-200 cursor-pointer hover:bg-slate-50 transition-all has-[:checked]:border-orange-500 has-[:checked]:bg-orange-50/30">
                                            <input type="checkbox" name="type_sinistre[]" value="{{ $value }}" class="w-4 h-4 text-orange-500 focus:ring-orange-400 border-slate-300 rounded incident-checkbox">
                                            <div class="ml-3 flex items-center gap-2">
                                                <i class="fa-solid {{ $data['icon'] }} {{ $data['color'] }} text-sm w-5 text-center"></i>
                                ...
                                <div id="selected-vehicle-display" class="mt-4 pt-4 border-t border-slate-100 hidden">
                                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">Véhicule sélectionné</p>
                                    <div class="flex items-center justify-between bg-slate-50/50 rounded-2xl p-3 border border-slate-100 group/veh">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-xl bg-orange-100 text-orange-600 flex items-center justify-center text-sm shadow-sm">
                                                <i class="fa-solid fa-car"></i>
                                            </div>
                                            <div class="overflow-hidden">
                                                <h5 id="display-vehicle-name" class="text-xs font-bold text-slate-800 leading-tight truncate"></h5>
                                                <p id="display-vehicle-plate" class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-0.5"></p>
                                            </div>
                                        </div>
                ...
                <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 overflow-hidden relative animate-in flex flex-col"
                    ...
                    <div class="p-6 md:p-8 flex-1 flex flex-col">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="w-8 h-8 rounded-full bg-purple-50 text-purple-600 flex items-center justify-center font-bold text-sm shrink-0">
                                2.5
                            </div>
                        ...
                        <div class="flex flex-col gap-5 flex-1">
                            <div>
                                <label class="block text-sm font-bold text-slate-700 mb-3">Établissement du constat <span class="text-red-500">*</span></label>
                                <div class="grid grid-cols-1 gap-2">
                                    <label id="label-constat-amiable" class="relative flex items-center p-3 rounded-xl border border-slate-200 cursor-pointer hover:bg-slate-50 transition-all has-[:checked]:border-purple-500 has-[:checked]:bg-purple-50/30">
                                        <input type="radio" name="methode_constat" id="constat-amiable" value="Amiable" class="w-4 h-4 text-purple-600 focus:ring-purple-500 border-slate-300" required>
                                        <div class="ml-3">
                                            <span class="block text-sm font-bold text-slate-800">Constat amiable</span>
                                            <span class="block text-[10px] text-slate-500">Rempli avec l'autre partie impliquée</span>
                                        </div>
                                    </label>
                                    <label class="relative flex items-center p-3 rounded-xl border border-slate-200 cursor-pointer hover:bg-slate-50 transition-all has-[:checked]:border-purple-500 has-[:checked]:bg-purple-50/30">
                                        <input type="radio" name="methode_constat" id="constat-police" value="Police_Gendarmerie" class="w-4 h-4 text-purple-600 focus:ring-purple-500 border-slate-300">
                                        <div class="ml-3">
                                            <span class="block text-sm font-bold text-slate-800">Police / Gendarmerie</span>
                                            <span class="block text-[10px] text-slate-500">Procès-verbal établi par les autorités</span>
                                        </div>
                                    </label>
                                </div>
                                <p id="corporel-warning" class="text-[10px] text-red-600 mt-2 font-bold hidden"><i class="fa-solid fa-triangle-exclamation mr-1"></i> Accident corporel : le constat amiable est interdit par la loi.</p>
                                <p id="bris-glace-info" class="text-[10px] text-blue-600 mt-2 font-bold hidden"><i class="fa-solid fa-info-circle mr-1"></i> Bris de glace : déclaration directe sans alerte des autorités.</p>
                            </div>
                            ...
                            <div class="flex items-center justify-between mb-2">
                                <label for="assurance_id" class="block text-sm font-bold text-slate-700">Compagnie d'assurance (Optionnel)</label>
                                <span id="assurance-linked-badge" class="hidden px-2 py-0.5 rounded-lg bg-blue-50 text-blue-600 text-[10px] font-bold border border-blue-100 animate-pulse">
