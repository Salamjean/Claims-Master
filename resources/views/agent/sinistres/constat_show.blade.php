            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-6">
                        <div class="space-y-2">
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Description des faits</p>
                        ...
                        <div class="space-y-2">
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider text-rose-500">Dommages et Dégâts</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                            <div class="space-y-2">
                                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Témoins / Impliqués</p>
                            ...
                            <div class="space-y-2">
                                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Vos Observations</p>
                                <p class="text-sm text-slate-600 bg-slate-50/50 p-3 rounded-lg border border-slate-100 min-h-[50px]">
                ...
                @if($constat->photos_plus && count($constat->photos_plus) > 0)
                    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                        <div class="px-5 py-3.5 border-b border-slate-100 bg-slate-50 flex items-center gap-3">
                            ...
                            <h3 class="font-bold text-slate-800 text-sm">Photos jointes ({{ count($constat->photos_plus) }})</h3>
                        </div>
