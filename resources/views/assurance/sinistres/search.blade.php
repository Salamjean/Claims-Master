...
@section('title', 'Recherche de dossier')
    ...
    <div>
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-slate-400">Retrouvez un sinistre par assuré, type, numéro ou agent</p>
            </div>
        </div>

        {{-- Formulaire de recherche --}}
        <form method="GET" action="{{ route('assurance.search') }}"
