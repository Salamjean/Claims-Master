...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        <div>
            <div class="flex items-center gap-3">
                <a href="{{ route('hopital.historique') }}" class="w-9 h-9 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-600 flex items-center justify-center transition-colors">
    ...
    @else
        <div class="bg-white p-12 rounded-2xl border border-slate-100 text-center space-y-3">
            ...
            <h3 class="text-slate-700 font-bold text-lg">Aucun état des lieux rédigé</h3>
            <p class="text-slate-400 text-sm">L'intervention a été clôturée directement sans rapport d'état des lieux.</p>
        </div>
    @endif
</div>
@endsection
