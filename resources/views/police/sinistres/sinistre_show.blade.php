                    ...
                    <div class="px-5 py-3.5 border-b border-slate-100 bg-orange-50/60 flex items-center gap-3">
                        ...
                        @if($sinistre->constat && $sinistre->constat->hospital_id)
                            <div class="border-t border-slate-100 pt-3">
                                <p class="text-[10px] uppercase tracking-wider text-slate-400 font-bold mb-1">Évacuation des blessés</p>
                ...
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                    <div class="px-5 py-3.5 border-b border-slate-100 bg-emerald-50/60 flex items-center gap-3">
                        <div class="w-7 h-7 rounded-lg bg-emerald-100 flex items-center justify-center text-xs"><i
                                class="fa-solid fa-user-shield text-emerald-600"></i></div>
                        <h3 class="font-bold text-slate-800 text-sm">Agent de terrain</h3>
                    </div>
                    <div class="p-5">
                        @if($sinistre->assignedAgent)
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="text-sm font-bold text-slate-800">{{ $sinistre->assignedAgent->name }} {{ $sinistre->assignedAgent->prenom }}</p>
                                    <p class="text-xs text-slate-500 font-medium mt-0.5">Contact direct : <span class="text-emerald-600 font-bold ml-1">{{ $sinistre->assignedAgent->contact }}</span></p>
                                </div>
                            </div>
                        @else
                            <div class="flex items-center gap-3 text-slate-400 py-2">
                                <i class="fa-solid fa-user-slash text-xl"></i>
                                <p class="text-sm font-medium">Aucun agent n'a encore récupéré ce dossier.</p>
                            </div>
                        @endif
                    </div>
                </div>
